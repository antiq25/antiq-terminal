...
banner = [
  ...
  "██─▀─███─█▄▀─████─████─██─██▀─█▄█▄▄▄▄─█████─████─▄█▀██─▄─▄██─█▄█─███─███─█▄▀─███─▀─███─██▀█<br>" +
  "▀▄▄▀▄▄▀▄▄▄▀▀▄▄▀▀▄▄▄▀▀▄▄▄▀───▄▄▀▀▀▄▄▄▄▄▀▀▀▀▄▄▄▀▀▄▄▄▄▄▀▄▄▀▄▄▀▄▄▄▀▄▄▄▀▄▄▄▀▄▄▄▀▀▄▄▀▄▄▀▄▄▀▄▄▄▄▄▀<br>" +
  '<span class="color2">Contribute to this project at <a class="command" href="https://github.com/mrepol742/terminal/">https://github.com/antiq25/terminal/</a></span>.',
...
credits = [
  '<br>',
  'Copyright (c) 2022 Melvin Jones Repol (<a href="https://antiq25.github.io">antiq25.github.io</a>). All Rights Reserved.',
...
copyright = [
  ...
  'Copyright (c) 2022 Melvin Jones Repol (<a href="https://antiq25.github.io">antiq25.github.io</a>). All Rights Reserved.',
  '<br>',
  ' License under the antiq25 License, version 1.0 (the "License");',
  ' you may not use this file except in compliance with the License.',
  ' You may obtain a copy of the License at',
  '<br>',
  '     <a href="https://github.com/antiq25/terminal/blob/master/LICENSE">https://github.com/antiq25/terminal/blob/master/LICENSE</a>',
  '<br>',
...
function commander(cmd) {
  ...
  switch (cmd.toLowerCase()) {
    ...
    case "webvium":
      ...
      break;
    case "trophy":
      loopLines(['<img alt="Github Trophy" src="https://github-profile-trophy.vercel.app/?username=antiq25&theme=gruvbox">'], "color2 margin", 80);
      break;
    case "stat":
      loopLines(['<img alt="Github Stats" src="https://github-readme-stats.vercel.app/api?username=antiq25&show_icons=true&count_private=true&theme=gruvbox&include_all_commits=true">'], "color2 margin", 80);
      break;
    case "stat -p":
      loopLines(['<img alt="Github Stats with Private Contributions" src="https://antiq25.github.io/github-stats/generated/overview.svg">'], "color2 margin", 80);
      break;
    case "lang":
      loopLines(['<img alt="Most Used Languages" src="https://github-readme-stats.vercel.app/api/top-langs/?username=antiq25&layout=compact&include_all_commits=true&&count_private=true&langs_count=20&theme=gruvbox">'], "color2 margin", 80);
      break;
    case "lang -f":
      loopLines(['<img alt="Most Used Languages by File Size" src="https://antiq25.github.io/github-stats/generated/languages.svg">'], "color2 margin", 80);
      break;
    case "streak":
      loopLines(['<img alt="\'Streak Stats\' Please refresh the page if the stats didnt show up" src="https://antiq25-streak-stats.herokuapp.com/?user=antiq25&theme=gruvbox">'], "color2 margin", 80);
      break;
    case "cont":
      loopLines(['<img alt="\'Contributions\' Please refresh the page if the graph didnt show up" src="https://antiq25-activity-graph.herokuapp.com/graph?username=antiq25&theme=github&hide_border=true">'], "color2 margin", 80);
      break;
    case "time":
    ...
    case "spotify":
      ...
      break;
    case "gif":
      loopLines(['<img alt="Detective Conan" src="https://antiq25-gif-randomizer.vercel.app/api/" /> '], "color2 margin", 80);
      break;
    case "trophy":
      loopLines(['<img alt="Detective Conan" src="https://antiq25-gif-randomizer.vercel.app/api/" /> '], "color2 margin", 80);
      break;
    ...
    case "social":
      ...
      newTab("https://antiq25.github.io/link-tree/?utm_medium=social&utm_source=antiq25.me");
      break;
    case "secret":
    ...
    case "projects":
      ...
      newTab("https://antiq25.github.io#projects");
      break;
    case "password":
    ...
    case "new":
      newTab("https://antiq25.me");
      break;
    case "new -w":
      window.open("https://antiq25.me", "", "width=1200, height=1200");
      break;
    case "exit":
    ...
    case "license":
      ...
      newTab("https://raw.githubusercontent.com/antiq25/terminal/master/LICENSE");
    break;
    case "copyright":
